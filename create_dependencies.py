...
for f in FILES:
    # Resources files
    qrc: Text = path.join(BASE_FOLDER, f"coffee_{f}_resources.qrc")  # Get the .qrc file
    qrc_py: Text = path.join(
        BASE_FOLDER, f"coffee_{f}_resources_rc.py"
    )  # File to create
    ...
    # UI files
    ui: Text = path.join(BASE_FOLDER, f"coffee_{f}_ui.ui")  # Get the .ui file
    ui_py: Text = path.join(BASE_FOLDER, f"coffee_{f}_ui.py")  # File to create
